                                    ...
                                    {sekolahList.map((sekolah, idx) => {
                                        ...
                                        return (
                                            <Link
                                                ...
                                                className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 flex gap-4 p-4"
                                            >
                                                {/* Portrait Gradient Thumbnail */}
                                                <div className={`w-32 h-40 shrink-0 rounded-xl bg-gradient-to-br ${gradient} relative overflow-hidden flex items-center justify-center`}>
                                                    <GraduationCap className="w-16 h-16 text-white/30" />
                                                    <div className="absolute top-2 right-2">
                                                        <span className="bg-white/20 backdrop-blur-sm text-white px-2 py-0.5 rounded-full text-[9px] font-black">
                                                            {sekolah.jenjang}
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex-1 flex flex-col min-w-0">
                                                    <h3 className="font-black text-slate-900 text-lg mb-1 line-clamp-2 group-hover:text-purple-600 transition-colors">
                                                        {sekolah.nama}
                                                    </h3>

                                                    <div className="flex items-start gap-2 text-sm text-slate-600 mb-3">
                                                        <MapPin className="w-4 h-4 mt-0.5 shrink-0" />
                                                        <span className="font-medium line-clamp-1">{sekolah.kota}{sekolah.provinsi && `, ${sekolah.provinsi}`}</span>
                                                    </div>

                                                    <div className="mt-auto flex items-center justify-between">
                                                        <div className="flex gap-2">
                                                            {sekolah.khusus_ikhwan && (
                                                                <span className="px-2 py-1 rounded-full bg-blue-100 text-blue-600 text-[10px] font-bold" title="Khusus Ikhwan">
                                                                    Laki-laki
                                                                </span>
                                                            )}
                                                            {sekolah.khusus_akhwat && (
                                                                <span className="px-2 py-1 rounded-full bg-pink-100 text-pink-600 text-[10px] font-bold" title="Khusus Akhwat">
                                                                    Perempuan
                                                                </span>
                                                            )}
                                                        </div>
                                                        <span className="text-xs font-bold text-purple-600 group-hover:translate-x-1 transition-transform whitespace-nowrap">
                                                            Lihat Detail &rarr;
                                                        </span>
                                                    </div>
                                                </div>
