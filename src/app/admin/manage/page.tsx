            ...
            for (let i = 0; i < items.length; i++) {
                if (items[i].type.indexOf('image') !== -1) {
                    ...
                    try {
                        ...
                        if (data.url) {
                            setEditingKajian(prev => prev ? { ...prev, imageUrl: data.url } : null);
                        ...
                        setNotification({ message: '❌ Gagal mengupload gambar', type: 'error' });
                    }
            ...
            <div className="flex flex-col md:flex-row gap-4">
                <div className="relative flex-1">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-12 py-4 bg-white border border-slate-200 rounded-2xl shadow-sm focus:ring-2 focus:ring-blue-500 outline-none font-medium"
                    />
                    {searchTerm && (
                        <button
