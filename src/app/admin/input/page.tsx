...
export default function InputSelectionPage() {
    ...
    useEffect(() => {
        if (!isLoading && isContributor) {
            router.replace('/admin/batch-input?mode=manual');
        }
    }, [isLoading, isContributor, router]);
        ...
        <div className="max-w-4xl mx-auto py-12 px-4 space-y-8">
            <div className="text-center space-y-4 mb-12">
                ...
                <p className="text-slate-500 text-lg max-w-2xl mx-auto">
                    Anda dapat memasukkan jadwal kajian secara manual{!isContributor && ' atau menggunakan kecerdasan buatan (AI) untuk mengekstrak data dari poster/teks'}.
                </p>
            </div>
